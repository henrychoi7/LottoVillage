...
import com.jjosft.android.lottovillage.activities.ParticipationHistoryActivity
import com.jjosft.android.lottovillage.activities.PointHistoryActivity
...
class HomeFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        view.home_button_go_to_paricipation.setOnClickListener({startActivity(Intent(activity, ParticipationHistoryActivity::class.java))})
        view.home_button_go_to_point.setOnClickListener({startActivity(Intent(activity, PointHistoryActivity::class.java))})
        ...
        BaseApplication.getInstance().getRetrofitMethod().getDetailsOfAllWinningInfo()
                ...
                .subscribe(object : Observer<Model.WinningInfoResponse> {
                    ...
                    override fun onComplete() {
                        retrieveHomeMyPoint(view)
                    }
                })
    }

    private fun retrieveHomeMyPoint(view: View) {
