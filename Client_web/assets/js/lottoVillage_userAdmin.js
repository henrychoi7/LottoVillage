...
var userAdmin = {
    ...
    drawUserTable : function(userData){
        var wrapper = $('#DataTables_Table_0');
    ...
    banUser: function() {
        alert('영구정지 했습니다!');
        $('.ban-btn').hide();
        $('#forpause').removeClass();
        $('#forpause').addClass('label label-danger');
        ...
        //         if (resData.isSuccess == true){
        //             alert('영구정지 했습니다!');
        //             window.location.href = '/Client_web/lottoVillage_userAdmin.html';
        //         }
        //     },
        //     error: function(request,status,error){
        //         alert("code:"+request.status+"\n"+"message:"+request.responseText+"\n"+"error:"+error);
    ...
    detailUser: function(){
        ...
        window.location.href = '/Client_web/lottoVillage_userDetails.html?index=' + phone;
    }
};
